...
Route::prefix('student')->group(function () {
    Route::get('/mascotGuideStatus', [MascotGuideController::class, 'globalStatus']);
    Route::get('/mascotGuideList', [MascotGuideController::class, 'publicList']);
    Route::get('/mascotGuideImage/{filename}', [MascotGuideController::class, 'image'])
...
Route::prefix('admin')->middleware('auth:sanctum')->group(function () {
    Route::middleware(EnsureAdminRole::class)->group(function () {
        ...
        Route::post('/updateMascotGuideStatus', [MascotGuideController::class, 'updateGlobalStatus']);
    });
    ...
    Route::post('/articleListAdmin', [AdminController::class, 'articleListAdmin']);
    Route::post('/addArticle', [AdminController::class, 'addArticle']);
    Route::post('/editArticle', [AdminController::class, 'editArticle']);
    Route::post('/articleDetail', [AdminController::class, 'articleDetail']);
    Route::post('/editArticleStatus', [AdminController::class, 'editArticleStatus']);
    ...
    Route::post('/adminDetail', [AdminController::class, 'adminDetail']);
